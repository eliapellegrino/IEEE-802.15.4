...
#define NOTIF_PACKET_PAYLOAD_SIZE     1 /*Payload size of notif packet. Nel pacchetto di notifica viene inviato il valore SN attuale, in modo da poter sincronizzare sempre le due board (sorta di error check)*/                  
...
/*Frame control definition (used to set the Frame Control field)*/
// For optimization, we could obmit Destination PAN, Source and Destination Address ---> set b6 = 0, b10-11 = 00, b14-15 = 00 in Frame Control field
